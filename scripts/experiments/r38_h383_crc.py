...
Pure offline compute on reports/experiments/adjudicated/r37-h382-ladder-arm1-*.json. No GPU, no LLM.
"""
...
def main():
    ...
    out = Path(f"reports/experiments/adjudicated/r38-h383-crc-{ts}.json")
