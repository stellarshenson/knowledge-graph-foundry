...
FORENSICS = Path("reports/experiments/adjudicated/identity-forensics-r11-final-20260706-205147.json")
FRAGMENT_PAIRS = [
...
def main():
    ...
    out = Path(f"reports/experiments/adjudicated/r35-h375-sdr-{ts}.json")
