...
Usage: python scripts/experiments/r38_h385_answer_replay.py   (GPU: local vLLM :8010)
"""
...
OFFLINE_LADDER = Path("reports/experiments/adjudicated/r37-h382-ladder-arm1-20260710T173529Z.json")
...
def main():
    ...
    out = Path(f"reports/experiments/adjudicated/r38-h385-answer-replay-{ts}.json")
    out.write_text(
        json.dumps(
            {
