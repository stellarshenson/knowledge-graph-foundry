...
Usage: python scripts/experiments/r44_h448_decomposition.py
Writes: reports/experiments/r44/h448-decomposition-<ts>.jsonl + class summary.
"""
...
OUT = Path("reports/experiments/r44")
...
def main():
    ...
    misses = []
    for run in sorted(Path("reports/experiments/r39").glob("h389-coverage-*.jsonl")):
