...
Usage: python scripts/experiments/r45_pass2.py [--dry-run]   (--dry-run: Stage A only, no load)
Writes: reports/experiments/r45/pass2-<ts>.jsonl (one record per miss: doc, fact, hit,
