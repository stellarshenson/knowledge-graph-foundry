...
- Grounding - S2; sota.md instrument-first rule; dumps in tmp/data-dumps/
...
Internal grounding: `results/bench/regression-ledger.md` (REG-1), `results/bench/progressive-probe-trajectory.jsonl`, `tmp/data-dumps/` (three boundary dumps), `docs/experiments/kgf-redesign-experiments.md` (R09 H61-H80, H47, H91, H107, H351, H370 lineage), `docs/kgf-sota.md` (Metrics discipline), `reports/r42-metrics-framework-literature-brief-20260711.md` (paired designs, MDE, registry).
