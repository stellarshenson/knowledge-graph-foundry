...
from kgf.extraction.resolution import resolve_entities, rewire_relationships
...
from kgf.types.ontology import OntologyState
...
class FluidAccumulator:
    ...
    def consolidate(
        ...
        if ontology.entity_types and not skip_type_enforcement:
            from kgf.extraction.unstructured import _enforce_ontology_types
...
def _apply_deferred_decisions(
    ...
    from kgf.extraction.resolution import _merge_entities
