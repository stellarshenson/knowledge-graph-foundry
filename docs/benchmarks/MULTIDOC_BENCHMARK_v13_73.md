# Multi-Doc Benchmark v13 - chao1-floor + merge-validation + clustering-prompt

**Hybrid Score**: 73%
**Deterministic**: 55/63 (87%)
**Generative**: 3.0/5.0
**Date**: 2026-03-10T18:53:06.899768

## Conditions

- **Config**: v13 chao1-floor + merge-validation + clustering-prompt
...
5. **graph_structure** - HAS_ENTITY relationships (actual=0)
6. **query_answerability** - Q: What is the pressure range of DreamStation?
7. **query_answerability** - Q: What modes does SleepStyle support?
8. **query_answerability** - Q: iBreeze specifications?
