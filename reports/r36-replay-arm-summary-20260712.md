...
Report: `reports/r36-h379-replay-20260712T104736Z.json` (script `scripts/r36_h379_replay.py`, log `logs/r36-h379-replay.log`)
...
Report: `reports/r36-h377-revalidation-20260712T110540Z.json` (script
`scripts/r36_h377_revalidation.py`, log `logs/r36-h377-revalidation.log`)
...
Report: `reports/r36-h378-drift-replay-20260712T110305Z.json` (script
`scripts/r36_h378_drift_replay.py`, log `logs/r36-h378-drift-replay.log`)
