# Multi-Doc Benchmark v05 - cross-type resolution + relationship rewiring

**Hybrid Score**: 86%
**Deterministic**: 61/63 (97%)
**Generative**: 3.8/5.0
**Date**: 2026-03-10T01:07:24.643781

## Conditions

- **Config**: v05 cross-type resolution + relationship rewiring
...
- **query_answerability** (2/5): The knowledge graph can only answer 2-3 of the 8 question types with specific data. It can identify some manufacturers (ResMed, BMC, Philips from product names) and partially answer which devices treat OSA (AirSense 10 AutoSet for Her, CPAP respirator, DreamMapper). However, it lacks comprehensive cross-manufacturer data for feature comparisons, pressure ranges, device modes, complete component lists, compliance standards, and technical specifications like weight/dimensions/sound levels. The graph is fragmented with incomplete product coverage and missing critical comparative specifications needed for thorough cross-manufacturer analysis.
