...
from kg_builder_cli.loading.loader import resolve_against_graph
from kg_builder_cli.types.config import AppConfig, Neo4jConfig
from kg_builder_cli.types.extraction import Entity, ExtractionResult, Relationship
...
def test_resolve_remaps_type_to_existing(config):
    ...
    with patch("kg_builder_cli.loading.loader.GraphDatabase") as mock_gdb:
