...
Sources: `docs/experiments/kgf-redesign-experiments.md`, `docs/defects.md`, `src/knowledge_graph_foundry/`, `scripts/r33_h365_repair.py`. All paths below relative to `/home/lab/workspace/learning/projects/knowledge-graph-foundry/`.
