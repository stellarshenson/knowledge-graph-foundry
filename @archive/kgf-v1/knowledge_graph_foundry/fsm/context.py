...
from knowledge_graph_foundry.events.signals import phase_transition as phase_transition_signal
from knowledge_graph_foundry.events.types import PhaseTransition
from knowledge_graph_foundry.fsm.states import STATES, TRANSITIONS, GraphState
    ...
    def _emit_transition(self, trigger: str) -> None:
        ...
        if self._neo4j_uri:
            try:
                ...
                from knowledge_graph_foundry.fsm.metanode import write_transition_node
