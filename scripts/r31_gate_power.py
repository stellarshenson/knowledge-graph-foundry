...
Usage: python scripts/r31_gate_power.py
"""
...
FAMILIES = {
    "v1-scratch": {
        "reports/h241-v1-recall.json": 0.7708,
        "reports/r29-v1-run1-stats.json": 0.7917,
        "reports/r29-v1-run2-stats.json": None,  # read below
    },
    "v2-scratch": {
        "reports/h241-v2-recall.json": 0.7708,
        "reports/h212-v2-recall.json": 0.7500,
        "reports/h212-v2-recall-rerun.json": 0.7917,
        "reports/r29-v2-run1-stats.json": None,
    },
}

PER_PROBE_FAMILY = [  # v2 family vectors for the empirical corroboration
    "reports/h212-v2-recall.json",
    "reports/h212-v2-recall-rerun.json",
    "reports/h241-v2-recall.json",
]
...
def main():
    ...
    ts = out["generated"]
    path = Path(f"reports/r31-gate-power-{ts}.json")
