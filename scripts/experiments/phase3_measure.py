...
Usage: python scripts/experiments/phase3_measure.py <run1|run2>
...
RECALL_JSON = f"reports/experiments/adjudicated/phase3-{RUN}-recall.json"
STATS_JSON = f"reports/experiments/adjudicated/phase3-{RUN}-stats.json"
