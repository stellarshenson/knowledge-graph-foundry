...
from kgf.events.signals import phase_transition as phase_transition_signal
from kgf.events.types import PhaseTransition
from kgf.fsm.states import STATES, TRANSITIONS, GraphState
    ...
    def _emit_transition(self, trigger: str) -> None:
        ...
        if self._neo4j_uri:
            try:
                ...
                from kgf.fsm.metanode import write_transition_node
