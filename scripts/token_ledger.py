...
METRICS_URL = "http://localhost:8010/metrics"  # NOTE: sibling parsers in scripts/experiments/r30_fast_ramp.py + r30_gpu_ramp.py - keep prefix logic in sync
LEDGER = Path("reports/experiments/token-ledger.jsonl")
