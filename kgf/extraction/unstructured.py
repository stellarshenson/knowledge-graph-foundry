...
if TYPE_CHECKING:
    ...
    from kgf.extraction.type_resolver import BayesianTypeResolver

from loguru import logger

from kgf.extraction.chunking import chunk_text
from kgf.extraction.dedup import deduplicate, normalize_entity_ids
from kgf.extraction.embeddings import generate_embeddings
from kgf.extraction.extract import LLMAuthError, create_extraction_client, extract_chunk
...
from kgf.extraction.parsing import parse_document  # noqa: E402
from kgf.extraction.prompts import build_extraction_prompt  # noqa: E402
from kgf.extraction.resolution import (  # noqa: E402
    resolve_entities,
    rewire_relationships,
)
from kgf.extraction.response_models import build_response_model  # noqa: E402
from kgf.ontology.buffer import OntologyBuffer  # noqa: E402
from kgf.types.config import AppConfig, LLMConfig  # noqa: E402
from kgf.types.document import Chunk  # noqa: E402
from kgf.types.extraction import (  # noqa: E402
    Entity,
    ExtractionMetadata,
    ExtractionResult,
    Relationship,
)
from kgf.types.ontology import OntologyState  # noqa: E402
...
def ingest_document(
    ...
    if config.extract.schema_signal_extraction and buffer:
        from kgf.extraction.schema_signals import (
            compute_coverage,
    ...
    if ontology and ontology.entity_types:
        ...
        if config.extract.bayesian_resolution and exemplar_index:
            from kgf.extraction.type_resolver import (
...
def _resolve_types_bayesian(
    ...
    """
    from kgf.extraction.type_resolver import ResolverContext
