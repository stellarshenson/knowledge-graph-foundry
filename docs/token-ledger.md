...
- **Cumulative** - 17.9M prompt + 30.0M generation = **47.9M tokens** (incl. 19.1M conservative pre-ledger backfill)
- **Saved vs Claude Sonnet 4.5 on Bedrock** (\$3/M in, \$15/M out - KGF's default frontier config): **\$504**
- **Saved vs Claude Haiku 4.5** (\$1/M in, \$5/M out): \$168
