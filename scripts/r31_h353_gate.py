...
Checkpoints per chunk to results/r31/h353-chunks.jsonl (detached-compute rule).

Usage: python scripts/r31_h353_gate.py
"""
...
CHECKPOINT = Path("results/r31/h353-chunks.jsonl")
PASSES = 6
CARRIERS_PER_GOLD = 3
...
def main():
    ...
    out = Path(f"reports/r31-h353-gate-{ts}.json")
    out.write_text(
        json.dumps(
            {
                "hypothesis": "R31-H353",
