...
Usage: python scripts/experiments/r43_structural_timeseries.py [config.yml] [every_n]
Writes: reports/experiments/r43/structural-timeseries-<ts>.jsonl (one record per
...
OUT = Path("reports/experiments/r43")
