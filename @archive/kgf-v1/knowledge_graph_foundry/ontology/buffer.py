...
from knowledge_graph_foundry.extraction.dedup import normalize_type_name
...
class OntologyBuffer:
    ...
    def _maybe_evolve(self) -> None:
        ...
        """
        from knowledge_graph_foundry.settings.defaults import GUIDE_EVOLUTION_MIN_ENCOUNTERS
    ...
    def evolve_resolution_guide(self) -> None:
        ...
        """
        from knowledge_graph_foundry.settings.defaults import (
