...
Output: reports/r32-h354-census-<ts>.json + printed class table.
"""
...
H353_CHUNKS = Path("results/r31/h353-chunks.jsonl")  # 6-pass emission record
...
def main():
    ...
    out = Path(f"reports/r32-h354-census-{ts}.json")
    out.write_text(
        json.dumps(
            {
                "hypothesis": "R32-H354",
