...
Internal grounding: `docs/experiments/kgf-redesign-experiments.md` (H351, H353, DEF-11, R34 composed frontier, H373, H389); `reports/r39-graph-construction-literature-brief-20260711.md` (MINE pattern, S1 open slot); `notebooks/h158_measure.py` (harness mechanics).
