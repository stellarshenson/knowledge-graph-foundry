...
- **Cumulative** - 19.7M prompt + 32.4M generation = **52.1M tokens** (incl. 19.1M conservative pre-ledger backfill)
- **Saved vs Claude Sonnet 4.5 on Bedrock** (\$3/M in, \$15/M out - KGF's default frontier config): **\$546**
- **Saved vs Claude Haiku 4.5** (\$1/M in, \$5/M out): \$182
