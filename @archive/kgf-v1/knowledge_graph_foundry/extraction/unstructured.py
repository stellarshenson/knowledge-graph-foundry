...
if TYPE_CHECKING:
    ...
    from knowledge_graph_foundry.extraction.type_resolver import BayesianTypeResolver
...
from knowledge_graph_foundry.extraction.parsing import parse_document  # noqa: E402
from knowledge_graph_foundry.extraction.prompts import build_extraction_prompt  # noqa: E402
from knowledge_graph_foundry.extraction.resolution import (  # noqa: E402
    resolve_entities,
    rewire_relationships,
)
from knowledge_graph_foundry.extraction.response_models import build_response_model  # noqa: E402
from knowledge_graph_foundry.ontology.buffer import OntologyBuffer  # noqa: E402
from knowledge_graph_foundry.types.config import AppConfig, LLMConfig  # noqa: E402
from knowledge_graph_foundry.types.document import Chunk  # noqa: E402
from knowledge_graph_foundry.types.extraction import (  # noqa: E402
    Entity,
    ExtractionMetadata,
    ExtractionResult,
    Relationship,
)
from knowledge_graph_foundry.types.ontology import OntologyState  # noqa: E402
...
def ingest_document(
    ...
    if config.extract.schema_signal_extraction and buffer:
        from knowledge_graph_foundry.extraction.schema_signals import (
            compute_coverage,
    ...
    if ontology and ontology.entity_types:
        ...
        if config.extract.bayesian_resolution and exemplar_index:
            from knowledge_graph_foundry.extraction.type_resolver import (
...
def _resolve_types_bayesian(
    ...
    """
    from knowledge_graph_foundry.extraction.type_resolver import ResolverContext
